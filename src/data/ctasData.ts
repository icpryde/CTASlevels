export type CTASLevel = 0 | 1 | 2 | 3 | 4 | 5;

export interface CTASEntry {
  description: string;
  level: CTASLevel;
}
...
export const ctasLevelLabels: Record<CTASLevel, string> = {
  0: 'Obviously Dead',
  1: 'Resuscitation',
  2: 'Emergency',
  3: 'Urgent',
...
export const presentingComplaints: Section = {
...
export const firstOrderModifiers: Section = {
...
export const secondOrderModifiers: Section = {
